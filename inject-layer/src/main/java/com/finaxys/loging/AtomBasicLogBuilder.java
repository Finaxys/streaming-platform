...
public class AtomBasicLogBuilder {
     ...
     *      - "Price";obName;price;executedQuty;dir;orderSourceID;orderMatchedID;bestaskPrice;bestbidPrice
     *
     * Log fields meaning:
     ...
     *      - orderSourceID: order ID that is at the source of the price
     *      - orderMatchedID: orderId of the pending order matching the order extId1
