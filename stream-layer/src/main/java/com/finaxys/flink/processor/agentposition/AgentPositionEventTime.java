 ...
 */
public class AgentPositionEventTime extends DefaultAgentPositionProcessor {
    private static Logger LOGGER = LogManager.getLogger(AgentPositionEventTime.class);

    public AgentPositionEventTime(DelaySimulationConfiguration delayConfig,
    ...
    protected DataStream processDataStream() {
        ...
        KeyedStream<TimestampedAtomLog, Tuple3<Long, String, String>> agentAndOrderBookKeyedLogs = orderLogs
                .keyBy(AgentPositionReference.CustomKeySelector.keyByEventTimeAgentAndOrderbook());
